                           ...
                           const jerry_property_descriptor_t *prop_desc_p) /**< property descriptor */
{
  ...
  prop_desc.is_enumerable = ECMA_CONVERT_BOOL_TO_FIELD (
      prop_desc_p->is_enumerable_defined ? prop_desc_p->is_enumerable : false);

  prop_desc.is_configurable_defined = ECMA_CONVERT_BOOL_TO_FIELD (
      prop_desc_p->is_configurable_defined);
  prop_desc.is_configurable = ECMA_CONVERT_BOOL_TO_FIELD (
      prop_desc_p->is_configurable_defined ? prop_desc_p->is_configurable : false);
  ...
  prop_desc.is_writable = ECMA_CONVERT_BOOL_TO_FIELD (
      prop_desc_p->is_writable_defined ? prop_desc_p->is_writable : false);
